...
Dentro do portugol (portugues estruturado) temos dois tipos de funcao:
 - Entrada e saida de dados
        * Escreva ()
        * Leia ()
        * Limpa ()
 - Execucao de tarefas
        * Criadas por voce, para resolver um problema especifico 

Os tipos de funcoes trabalham em conjunto.
*/

programa {
  funcao inicio() {

    //Numerico (Interiro ou Real)
    inteiro numero = 12
    real valor = 12.5

    //Literal (Textos)
    caracter status = 'S'
    cadeia nome = 'Maria dos Remedios'

    //Logico
    logico compra = 'F'

    const inteiro LOJA_PRINCIPAL = 1234
